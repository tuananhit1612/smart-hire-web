                ...
                <div>
                        ...
                        <AnimatePresence mode="popLayout">
                            {project.technologies.map((tech, techIndex) => (
                                <motion.span
                                    ...
                                    className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg text-xs font-medium bg-gradient-to-r from-indigo-500/10 to-purple-500/10 border border-indigo-200 dark:border-indigo-800 text-indigo-700 dark:text-indigo-300"
                                >
                                    {tech}
                                    <button
                    ...
                    <div className="relative">
                        ...
                        {showSuggestions && filteredSuggestions.length > 0 && (
                            <div className="absolute z-20 mt-1 w-full bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 rounded-xl shadow-lg overflow-hidden">
                                {filteredSuggestions.map((tech) => (
                                    <button
                                        key={tech}
                                        type="button"
                                        onClick={() => handleSelectSuggestion(tech)}
                                        className="w-full px-4 py-2 text-left text-sm hover:bg-indigo-50 dark:hover:bg-indigo-900/20 text-gray-700 dark:text-gray-300 transition-colors"
                                    >
                                        {tech}
                                    </button>
                                ))}
