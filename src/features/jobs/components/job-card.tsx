...
export function JobCard({ job, onSave, onApply }: JobCardProps) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-700/50 rounded-2xl p-5 shadow-sm hover:shadow-xl hover:shadow-sky-500/10 transition-all duration-300 relative overflow-hidden"
    >
      ...
      <div className="relative flex flex-col h-full gap-4">
        ...
        <div className="flex items-center justify-between gap-3 pt-4 mt-2 border-t border-slate-100 dark:border-slate-800">
            <Button 
                variant="ghost" 
                size="icon" 
                className="text-slate-400 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors rounded-full"
