                ...
                >
                    ...
                    <h1 className="text-center font-heading font-extrabold text-[2rem] sm:text-[2.5rem] md:text-[2.75rem] lg:text-[4.5rem] leading-[1.2] lg:leading-[1.2] mb-6">
                        ...
                        <span className="block mt-1">
                            <span className="bg-gradient-to-r from-[#22c55e] via-[#10b981] to-[#FFAB00] bg-[length:400%_400%] bg-clip-text text-transparent animate-gradient pb-3 inline-block leading-[1.3]">
                                Thành Công Dễ Dàng!
                            </span>
                        </span>
                    </h1>
