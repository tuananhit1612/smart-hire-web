...
export function Footer() {
    return (
        <footer className="w-full border-t border-sky-200 bg-white pt-20 pb-12 relative z-10">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-16">
                    <div className="col-span-2 md:col-span-1 pr-8">
                        <div className="flex items-center gap-2.5 mb-6">
                            ...
                            <span className="text-xl font-bold text-sky-900 font-sans">SmartHire</span>
                        </div>
                    ...
                    <div>
                        <h4 className="font-bold text-sky-900 mb-6">Sản Phẩm</h4>
                        <ul className="space-y-3 text-sm text-sky-600">
                            ...
                            <li><Link href="#" className="hover:text-blue-600 transition-colors">Doanh Nghiệp</Link></li>
                        </ul>
                    </div>
                    <div>
                        <h4 className="font-bold text-sky-900 mb-6">Công Ty</h4>
                        <ul className="space-y-3 text-sm text-sky-600">
                    ...
                    <div>
                        <h4 className="font-bold text-sky-900 mb-6">Pháp Lý</h4>
                        <ul className="space-y-3 text-sm text-sky-600">
                            ...
                            <li><Link href="#" className="hover:text-blue-600 transition-colors">An Toàn</Link></li>
                        </ul>
                    </div>
                </div>
                <div className="pt-8 border-t border-sky-100 flex flex-col md:flex-row justify-between items-center gap-6">
                    <p className="text-sm text-sky-600 font-medium">&copy; 2030 SmartHire Inc. All rights reserved.</p>
                    <div className="flex items-center gap-6">
                        <Globe2 className="h-5 w-5 text-sky-400 hover:text-blue-600 transition-colors cursor-pointer" />
                    </div>
                </div>
            </div>
        </footer>
