        ...
        <section className="relative z-10 pt-24 pb-12 md:pt-28">
            <div className="mx-auto max-w-6xl px-4 sm:px-6">
                ...
                <motion.div
                    ...
                    className="mb-8"
                >
                    <h1 className="text-2xl font-bold text-sky-900">HR Dashboard</h1>
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-sm font-bold text-sky-900">Ứng viên theo tuần</h3>
                            </div>
                        ...
                        <div className="flex items-end justify-between px-2">
                            ...
                            <div className="text-right ml-4">
                                <p className="text-2xl font-black text-sky-900">85</p>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                    ...
                    >
                        <div className="flex items-center justify-between mb-4">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-sm font-bold text-sky-900">Top tin tuyển dụng</h3>
                            </div>
                            <button className="text-xs text-slate-400 hover:text-sky-600 transition-colors cursor-pointer">
                                Xem tất cả →
                            </button>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <p className="text-sm font-semibold text-sky-900 truncate group-hover:text-sky-600 transition-colors">
                                                {job.title}
                                            </p>
                    ...
                    >
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h3 className="text-sm font-bold text-sky-900">Hoạt động gần đây</h3>
                        </div>
