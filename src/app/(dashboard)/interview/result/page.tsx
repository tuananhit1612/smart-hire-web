...
const CATEGORY_LABELS: Record<string, { label: string; color: string }> = {
    introduction: { label: "Giới thiệu", color: "bg-[#22c55e] dark:bg-[#22c55e]/30 text-[#22c55e] dark:text-[#22c55e]" },
...
function EvaluationCard({
    ...
    const getScoreColor = (score: number) => {
        ...
        if (score >= 60) return "text-[#22c55e] bg-[#22c55e] dark:bg-[#22c55e]/20 dark:text-[#22c55e]";
                    ...
                    >
                        <div className="px-4 pb-4 space-y-4 border-t border-slate-50 dark:border-white/[0.04] pt-3">
                            ...
                            <div>
                                ...
                                <div className="bg-[#22c55e]/50 dark:bg-[#22c55e]/10 rounded-xl p-3 text-base text-slate-700 dark:text-[#C4CDD5] leading-relaxed border border-[#22c55e]/50 dark:border-[#22c55e]/30">
